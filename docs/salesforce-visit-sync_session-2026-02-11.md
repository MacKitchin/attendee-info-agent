...
2. Loop: Count `varTotalCount` and `varMissingCount` (where Attendee_Name**c or Attendee_Email**c is null)
3. Decision:
...
- Sender Address: `attendeeinfo@informa.com` _(changed from `production@connectmeetings.com` on 2026-02-19)_
...
**Status in org:** Active _(activated 2026-02-19)_
